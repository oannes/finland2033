...
export function loadContent(): GameContent {
  ...
  cached = {
    ...
    dilemmas: (() => { const md = optionalFile('dilemmas.md'); return md ? parseDilemmas(md) : [] })(),
    interludes: (() => { const md = optionalFile('interludes.md'); return md ? parseInterludes(md) : [] })(),
    about: optionalFile('about.md') ?? undefined,
    sources: optionalFile('sources.md') ?? undefined,
