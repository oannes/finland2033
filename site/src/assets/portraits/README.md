...
Drop files here and they go live automatically — no code edits. Naming:

    <id>-now.webp          portrait today (2026/27)
    <id>-2028.webp         portrait around 2028 (decision 1–2 reveals)
    <id>-2033.webp         portrait in 2033 (decision 3 + endstate)
    <id>-env.webp          the person in their own environment (hover)
    <id>-mood-<mood>.webp  mood face, marja/eetu only
...
- marja-env, eetu-env   (hover environment shots; all seven seats are in)
